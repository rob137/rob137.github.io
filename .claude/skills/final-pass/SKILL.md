...
Present findings as two lists (tells and cohesion issues), each with line numbers and specific text. Then propose concrete edits. Wait for approval before making changes.
