...
His work on [tinygrad](https://github.com/tinygrad/tinygrad) is low-level, performance-critical, novel. The kind of work that might stay inner-loop for a long time, if it ever accommodates AI at all.
