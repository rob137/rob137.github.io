...
Eric Raymond [announced a project](https://x.com/esrtweet/status/2006812050740375672) over the new year: a tool to compile data model descriptions directly into CRUD applications. The interesting part wasn't the tool itself - it was his framing.
...
[Eternal September](https://en.wikipedia.org/wiki/Eternal_September) marked the moment the mainstream arrived. But the infrastructure was already there. The protocols, the tools, the culture. All built by people who couldn't have predicted what they were building for.

## Position before submission

I wrote [before](/2026/01/03/position-before-submission/) about the BJJ principle of establishing position before attempting a submission. The same logic applies here. You don't need to know exactly where you're going. You need to be in a position where multiple outcomes work.
...
The [horseless carriage](/2026/01/02/golden-retriever-problem/) instinct is strong. We naturally describe new things in terms of old things. But the old thing is a bad guide when the target is moving this fast.
