...
Each one pushes "think carefully about the domain up front" one step further down the pipeline. SDD is what you get when you combine DDD's ubiquitous language with BDD's executable specs and give them to something that can actually write the implementation. What changed isn't the idea. What changed is that "the implementation follows" used to be aspirational and is now literal.

---

I'm genuinely ambivalent about this, though.
