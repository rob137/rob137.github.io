...
- **Line by line** - review as the agent writes
...
That might sound reckless. It probably is, by current norms. But Yegge's been early to a lot of things. He predicted the [rise of the "superengineer"](https://steve-yegge.medium.com/six-new-tips-for-better-coding-with-agents-d4e9c86e42a9) - someone who can orchestrate 100 agents and match the output of 50+ traditional engineers.

If that future arrives, the current debates about line-level versus commit-level review will look like arguments about whether to hand-verify your compiler's register allocation.
...
But there are also good reasons to notice when caution starts looking like the people who insisted on reading assembly output in 1995. The ground shifts. The norms shift with it. What's YOLO today might just be Tuesday in a few years.
