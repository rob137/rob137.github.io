...
The rule that you should say "fewer" for countable nouns and "less" for uncountable ones was invented by a grammarian in 1770. Before that, people used them interchangeably for centuries. An observation about formal usage was hardened into a prescription about correctness. We do this constantly - not the philosopher's [is/ought](https://en.wikipedia.org/wiki/Is%E2%80%93ought_problem) exactly, but the same shape - slide from describing how things are to insisting that's how they ought to be.
