...
Josh briefly demoed Claude Code's [multi-agent mode](https://docs.anthropic.com/en/docs/claude-code/sub-agents#choose-between-subagents-and-main-conversation), currently in beta. Main conversation plus n sub-agent panes in one terminal. There was an animation of making a change and watching it ripple through. The audience reaction was telling: awe, but also unease. I think that unease is a desire line. Most users will want to be pushed away from this complexity, not into it.
