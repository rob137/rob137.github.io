...
- **Adding intelligence to a medium you're already comfortable in.** I've been running an experiment: a verbose org-mode to-do list, with a long-running Codex CLI instance watching and editing the same file. We interact primarily through the document. It updates me in bold text as it works. I still have the chat open, still jump in when needed - but it's surprising how viable this already is. The same pattern shows up everywhere. Claude hooked into an Excel worksheet. A Slack bot in your existing group chats, backed by an LLM. You're not learning a new interface. You're adding capability to a surface you already know.
